...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2026 at 02:36 PM
...
CREATE TABLE `bookings` (
  ...
  `status` enum('waiting_to_arrive','checked_in','in_progress','for_pickup','waiting','groomed','waiting_for_payment','completed','cancelled','no_show') NOT NULL DEFAULT 'waiting_to_arrive',
...
INSERT INTO `bookings` (`booking_id`, `booking_reference`, `user_id`, `window_id`, `booking_date`, `number_of_pets`, `booking_type`, `status`, `queue_number`, `special_notes`, `cancellation_reason`, `total_amount`, `created_at`, `updated_at`, `reschedule_count`, `cancel_count`) VALUES
(1, 'BAC-20260415-0001', 6, 3, '2026-04-23', 1, 'online', 'cancelled', NULL, 'My dog is friendly', NULL, 0.00, '2026-04-11 21:23:56', '2026-04-15 21:58:57', 1, 1),
(2, 'BAC-20260413-0002', 7, 1, '2026-04-13', 1, 'online', 'waiting_to_arrive', NULL, NULL, NULL, 0.00, '2026-04-11 21:47:08', '2026-04-11 21:47:08', 0, 0),
(3, 'BAC-20260412-0003', 7, 1, '2026-04-12', 1, 'online', 'waiting_to_arrive', NULL, NULL, NULL, 0.00, '2026-04-11 21:59:58', '2026-04-11 21:59:58', 0, 0),
(4, 'BAC-20260414-0001', 7, 3, '2026-04-14', 1, 'online', 'waiting_to_arrive', NULL, NULL, NULL, 0.00, '2026-04-13 23:09:15', '2026-04-13 23:09:15', 0, 0),
(5, 'BAC-20260415-0002', 7, 1, '2026-04-15', 1, 'online', 'waiting_to_arrive', NULL, NULL, NULL, 0.00, '2026-04-13 23:20:08', '2026-04-13 23:20:08', 0, 0),
(6, 'BAC-20260416-0001', 6, 4, '2026-04-16', 1, 'online', 'cancelled', NULL, NULL, NULL, 0.00, '2026-04-14 23:02:38', '2026-04-15 22:40:29', 0, 1),
(7, 'BAC-20260416-0002', 10, 4, '2026-04-16', 1, 'online', 'for_pickup', 1, NULL, NULL, 0.00, '2026-04-14 23:15:02', '2026-04-16 20:58:12', 0, 0),
(8, 'BAC-20260415-0003', 10, 3, '2026-04-15', 1, 'online', 'waiting_to_arrive', NULL, NULL, NULL, 0.00, '2026-04-14 23:19:05', '2026-04-14 23:19:05', 0, 0),
(9, 'BAC-20260417-0001', 6, 3, '2026-04-17', 1, 'online', 'cancelled', NULL, NULL, NULL, 0.00, '2026-04-15 21:11:12', '2026-04-15 22:39:48', 0, 1),
(12, 'BAC-20260417-0002', 11, 1, '2026-04-17', 1, 'online', 'cancelled', 1, NULL, NULL, 0.00, '2026-04-16 21:19:35', '2026-04-16 21:43:52', 0, 1),
(13, 'BAC-20260417-0003', 6, 4, '2026-04-16', 1, 'online', 'cancelled', 2, NULL, NULL, 0.00, '2026-04-16 21:33:57', '2026-04-16 21:40:57', 1, 1),
(14, 'BAC-20260418-0001', 6, 1, '2026-04-18', 1, 'online', 'waiting_to_arrive', NULL, NULL, NULL, 0.00, '2026-04-16 21:42:09', '2026-04-16 21:42:09', 0, 0),
(25, 'BAC-20260417-0004', 12, 2, '2026-04-17', 1, 'online', 'waiting_to_arrive', NULL, NULL, NULL, 0.00, '2026-04-16 21:56:02', '2026-04-16 21:56:02', 0, 0),
(26, 'BAC-20260417-0005', 11, 6, '2026-04-17', 1, 'online', 'waiting_to_arrive', NULL, NULL, NULL, 0.00, '2026-04-16 22:50:40', '2026-04-16 22:50:40', 0, 0);
...
(63, 'App\\Models\\User', 1, 'admin_token', 'a202c6e664d56a53ea455260ad032b2a4540ba063af09882cb16b5852da44a1f', '[\"*\"]', '2026-04-16 07:04:26', NULL, '2026-04-16 05:56:37', '2026-04-16 07:04:26'),
(65, 'App\\Models\\User', 11, 'auth_token', 'bebc5016d7bf210154c31a3ae264582dc1415439d48724155a506cdef7674229', '[\"*\"]', '2026-04-16 06:50:40', NULL, '2026-04-16 06:18:20', '2026-04-16 06:50:40');
...
INSERT INTO `users` (`user_id`, `first_name`, `last_name`, `phone`, `email`, `password_hash`, `role`, `customer_tier`, `profile_photo`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 'Admin', 'Bethlehem', '09000000000', 'admin@bethlehem.com', '$2y$12$3oQ4z6SOCmdWNpgL1J9k/e8jNG1iamRiE3Fjwdrd2YUeNGVDAka9.', 'admin', 'new', NULL, 1, '2026-04-10 23:40:18', '2026-04-13 21:52:34'),
(2, 'Juan', 'Dela Cruz', '09171234567', 'juan@example.com', '$2y$12$faVX2VR5SzyqGR86QqJdBebpXb62FoNQSomcvOHPBDrqXB1wzxzWu', 'customer', 'new', NULL, 1, '2026-04-11 07:53:32', '2026-04-11 07:53:32'),
(3, 'Ridge', 'Oniram', '234324', 'ridgemarino.biio23@gmail.com', '$2y$12$aCdUEk6ylE6VACAjy7q1tu/wVsprsJLY8ok7DXZYj9CXLPtMaF.Sq', 'customer', 'new', NULL, 1, '2026-04-11 07:59:41', '2026-04-11 07:59:41'),
(6, 'Juan', 'Dela Cruz', '09123456789', 'juan23@test.com', '$2y$12$7sXzVCyHkDXThS8EFiOo1uq4zy6AmSxRugqabhDUS9Jq2J51UXoPK', 'customer', 'new', NULL, 1, '2026-04-11 09:37:01', '2026-04-11 09:37:01'),
(7, 'Ridge', 'Marino', '09987654321', 'ridgee.marino@gmail.com', '$2y$12$DY9RJM1AKsKAzp1SsCrIEud2RBEG8nlx7efc6F9NTTLuf8fY8h9Ha', 'customer', 'new', NULL, 1, '2026-04-11 10:36:43', '2026-04-11 10:36:43'),
(8, 'rij', 'Marino', '09121234567', 'ridge@gmail.con', '$2y$12$.7Yamcsy4F0h7GIpkWJ0IOMxXI8oITtNe.t9vq2dGQJQ/Ei4oCwWu', 'customer', 'new', NULL, 1, '2026-04-14 21:04:00', '2026-04-14 21:04:00'),
(9, 'Ridge', 'Oniram', '09123768577', 'fhg@jdgk.jfj', '$2y$12$QiqtINOCDLOD5D2/JDLPj.7rsVQh9CJHkQgh/onFAs8gsmbe4P8Eq', 'customer', 'new', NULL, 1, '2026-04-14 21:12:05', '2026-04-14 21:12:05'),
(10, 'fds', 'sytre', '09999999999', '091863236@agd', '$2y$12$4atrH1l0fD78eNDcETDs2O8/TupcTUgHLE4lLogixefe6LPLiTWVS', 'customer', 'new', NULL, 1, '2026-04-14 23:04:30', '2026-04-14 23:04:30'),
(11, 'Gerald', 'Senining', '09090909099', 'juan23@test.comert', '$2y$12$luN32Kq9JBTWN4gZVe/LUOWQ1EjYSEpzniT2HDWytNtrR7vc5cn2y', 'customer', 'new', NULL, 1, '2026-04-16 21:14:49', '2026-04-16 21:14:49'),
(12, 'Juan', 'Oniram', '09090909090', 'hgf@hdf', '$2y$12$LCfM2kgbI/do9CQhue560uQHTAmRQEA8UrL.LEaCrEo6lVkmjM8r6', 'customer', 'new', NULL, 1, '2026-04-16 21:47:11', '2026-04-16 21:47:11');
...
--
ALTER TABLE `booking_pets`
  MODIFY `booking_pet_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `booking_services`
--
ALTER TABLE `booking_services`
  MODIFY `booking_service_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `notifications`
  MODIFY `notification_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
