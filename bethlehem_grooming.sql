...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 15, 2026 at 01:57 PM
...
CREATE TABLE `bookings` (
  ...
  `status` enum('waiting_to_arrive','waiting','in_progress','groomed','waiting_for_payment','completed','cancelled','no_show') NOT NULL DEFAULT 'waiting_to_arrive',
...
(1, 'BAC-20260415-0001', 6, 1, '2026-04-15', 1, 'online', 'waiting_to_arrive', NULL, 'My dog is friendly', NULL, 0.00, '2026-04-11 21:23:56', '2026-04-11 21:23:56', 0, 0),
...
(6, 'BAC-20260416-0001', 6, 4, '2026-04-16', 1, 'online', 'waiting_to_arrive', NULL, NULL, NULL, 0.00, '2026-04-14 23:02:38', '2026-04-14 23:02:38', 0, 0),
(7, 'BAC-20260416-0002', 10, 4, '2026-04-16', 1, 'online', 'waiting_to_arrive', NULL, NULL, NULL, 0.00, '2026-04-14 23:15:02', '2026-04-14 23:15:02', 0, 0),
...
(1, 'booked', 6, 'New booking BAC-20260416-0001 by Juan Dela Cruz on 2026-04-16 at 11:00 AM - 12:00 PM.', 0, '2026-04-14 07:02:38'),
(2, 'booked', 7, 'New booking BAC-20260416-0002 by fds sytre on 2026-04-16 at 11:00 AM - 12:00 PM.', 0, '2026-04-14 07:15:02'),
(3, 'booked', 8, 'New booking BAC-20260415-0003 by fds sytre on 2026-04-15 at 10:00 AM - 11:00 AM.', 0, '2026-04-14 07:19:05');
...
--
ALTER TABLE `booking_pets`
  MODIFY `booking_pet_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `pets`
  MODIFY `pet_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
